$(document).ready(function(){
  ...
  var modalText = {
    standapp: {
      ...
      link: 'https://kyoung3212.github.io/react-stand-app/',
    ...
    whack: {
      ...
      link: 'https://kyoung3212.github.io/react-whack-a-mole/',
    ...
    drumkit: {
      ...
      link: 'https://kyoung3212.github.io/react-drumkit/',
...
// CLOSE MODAL ONCLICK OUTSIDE MODAL
  ...
  function fillModal(id) {
    ...
    if (modalText[id].github) $('#modal .github').addClass('visible')
                                               .parent()
